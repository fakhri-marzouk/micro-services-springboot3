package com.alibou.studentcommand.controller;
...
import com.alibou.studentcommand.service.StudentService;
...
public class StudentController {
    ...
    @PostMapping
    public ResponseEntity<String> save(@RequestBody StudentEvent student) {
        try {
